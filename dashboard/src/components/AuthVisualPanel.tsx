...
export function AuthVisualPanel() {
  return (
    <div className="relative hidden overflow-hidden bg-[#0f1420] lg:block">
      <div
      ...
      <div
        className="absolute inset-0"
        style={{
          background: "radial-gradient(circle at 70% 30%, rgba(91,108,255,0.22), transparent 55%)",
        }}
      />
      <svg
        viewBox="0 0 400 300"
        className="absolute right-0 bottom-0 h-2/3 w-2/3 text-[#5b6cff]"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
      >
