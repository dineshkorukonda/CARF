...
export const env = {
  ...
  /** Secret used by Auth.js to encrypt session cookies / tokens. */
  authSecret: () => requireEnv("AUTH_SECRET"),
  /** GitHub App client credentials for OAuth sign-in. */
  authGithubId: () => requireEnv("AUTH_GITHUB_ID"),
  authGithubSecret: () => requireEnv("AUTH_GITHUB_SECRET"),
