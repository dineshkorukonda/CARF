...
export default function Home() {
  ...
  return (
    <main className="bg-white">
      ...
      {/* ── Post heading — centered, like TM blog ── */}
      <div className="max-w-[720px] mx-auto px-6 pt-16 pb-10">
        ...
        <div className="flex items-center gap-2 font-['Inter',system-ui,sans-serif] text-[13px] text-[#888]">
          <span className="font-medium text-[#555]">CARF Team</span>
          <span className="text-[#ccc]">·</span>
          <span>Aug 13, 2026</span>
        </div>
      </div>

      {/* ── Cover image — full-width centered, like mm-cube-cover.svg ── */}
      ...
      {/* ── Content shell: left TOC + article, like TM blog ── */}
      <div className="max-w-[1060px] mx-auto px-6 pb-32">
        <div className="flex gap-16 items-start">
          ...
          <nav
            ...
            className="hidden lg:block sticky top-10 w-[190px] shrink-0 font-['Inter',system-ui,sans-serif] text-[12.5px] leading-[1.55]"
          >
          ...
          <article className="min-w-0 flex-1 max-w-[640px] font-['Lora',Georgia,serif] text-[17.5px] leading-[1.75] text-[#222]">
            ...
            <h2
              id="introduction"
              className="scroll-mt-16 font-['Lora',Georgia,serif] text-[1.25rem] font-semibold leading-[1.25] tracking-[-0.015em] text-[#0a0a0a] mt-0 mb-3"
            >
              Introduction
            </h2>
            <p className="mb-5">
            ...
            <h2
              id="motivation"
              className="scroll-mt-16 font-['Lora',Georgia,serif] text-[1.25rem] font-semibold leading-[1.25] tracking-[-0.015em] text-[#0a0a0a] mt-10 mb-3"
            >
            ...
            <figure className="my-8">
              <Image
                ...
                className="w-full h-auto block"
              />
              <figcaption className="mt-3 font-['Inter',system-ui,sans-serif] text-[12.5px] leading-[1.5] text-[#999]">
            ...
            <div className="mt-10 mb-10">
              <Link
                href="https://dl.acm.org/conference/example"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center font-['Inter',system-ui,sans-serif] text-[15px] font-medium text-[#111] no-underline border-b border-b-[#111] pb-[1px] hover:opacity-40 transition-opacity"
              >
            ...
            {/* § Citation */}
            <div id="citation" className="scroll-mt-16 pt-8 border-t border-[#e5e5e5]">
              <p className="font-['Inter',system-ui,sans-serif] text-[11px] font-semibold tracking-[0.12em] uppercase text-[#aaa] mb-3">
                Citation
              </p>
              <p className="mb-3 font-['Inter',system-ui,sans-serif] text-[14px] text-[#444]">
                Please cite this work as:
              </p>
              <pre className="bg-[#f6f6f6] border border-[#e5e5e5] p-4 font-mono text-[12.5px] leading-[1.6] text-[#444] overflow-x-auto whitespace-pre-wrap">
{`CARF Team, "Change-Aware Automated Rollback Decisions
for DevOps Pipelines", 2026.`}
              </pre>
            </div>
